...
public class StringDemoTask3 {

    public static void main(String[] args) {

        /*
         * Write a program that reads the first name of mother and father if they expecting boy or girl?
         * Based on the input suggests a name for a baby: Example Output: Mom's first name?
         * Mary Dad's first name? Daniel Boy or Girl? boy Suggested baby name: DANRY
